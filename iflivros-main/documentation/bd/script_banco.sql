...
('O Sol é Para Todos', 'Drama', 'Indisponivel', 'Harper Lee'),
('A Vida Invisível de Addie LaRue', 'Fantasia', 'Disponível', 'V.E. Schwab'),
('A Garota que Roubava Livros', 'Drama', 'Indisponivel', 'Markus Zusak'),
('O Nome do Vento', 'Fantasia', 'Disponível', 'Patrick Rothfuss'),
('O Sol Também é Uma Estrela', 'Romance', 'Indisponivel', 'Nicola Yoon'),
('A Sombra do Vento', 'Suspense', 'Disponível', 'Carlos Ruiz Zafón'),
('O Ceifador', 'Fantasia', 'Indisponivel', 'Neal Shusterman'),
('A Casa dos Espíritos', 'Romance', 'Disponível', 'Isabel Allende'),
('Os Homens Que Não Amavam as Mulheres', 'Suspense', 'Indisponivel', 'Stieg Larsson'),
('A Garota do Trem', 'Suspense', 'Disponível', 'Paula Hawkins'),
('O Lobo de Wall Street', 'Memórias', 'Indisponivel', 'Jordan Belfort'),
('A Hospedeira', 'Ficção Científica', 'Disponível', 'Stephenie Meyer'),
('A Revolução dos Bichos', 'Fábula', 'Indisponivel', 'George Orwell'),
('O Homem de Areia', 'Terror', 'Disponível', 'Fritz Lieber'),
('A Coluna de Fogo', 'Histórico', 'Indisponivel', 'Ken Follett'),
('O Andar do Bêbado', 'Ciência', 'Disponível', 'Leonard Mlodinow'),
('A Última Nota', 'Drama', 'Indisponivel', 'A.J. Banner'),
('O Leitor', 'Drama', 'Disponível', 'Bernhard Schlink'),
('A Cidade do Sol', 'Drama', 'Indisponivel', 'Khaled Hosseini');
